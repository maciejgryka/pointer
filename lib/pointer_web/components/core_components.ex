defmodule PointerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PointerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PointerWeb.Gettext, "errors", msg, opts)
    end
  end
